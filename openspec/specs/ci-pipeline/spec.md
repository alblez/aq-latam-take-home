...
GitHub Actions CI workflow that runs the project's quality gates in parallel on every push and pull request, with an aggregate status check for branch protection.
