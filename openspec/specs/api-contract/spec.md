...
The stabilized API contract between the FastAPI backend and the Next.js frontend, including owner-scoping, the structured error model, the codegen pipeline, and the drift checks that keep both sides aligned.
